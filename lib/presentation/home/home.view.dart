        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                const Text("Start Video Call").defaultStyle().fontSize(20).fontWeight(FontWeight.w500).color(
                      const Color(0xFF222222),
                    ),
                const SizedBox(
                  height: 16,
                ),
                const Text("Start video call in mode:").defaultStyle().fontWeight(FontWeight.w400).fontSize(15).color(
                      const Color(0xFF222222),
                    ),
                const SizedBox(
                  height: 24,
                            ...
                            child: SizedBox(
                              ...
                              child: Observer(
                                builder: (_) => NormalButton(
                                  backgroundColor:
                                      viewModel.callMode == CallModeType.sfu ? const Color(0xFFE14D4D) : Colors.white,
                                  onPressed: () => viewModel.setCallModeType(CallModeType.sfu),
                          ...
                          Expanded(
                            ...
                            child: SizedBox(
                              ...
                              child: Observer(
                                builder: (_) => NormalButton(
                                  backgroundColor:
                                      viewModel.callMode == CallModeType.mesh ? const Color(0xFFE14D4D) : Colors.white,
                                  child: const Text("MESH")
                                      .defaultStyle()
                                      .fontSize(13)
                                      .color(viewModel.callMode == CallModeType.sfu ? Colors.black : Colors.white),
                                  onPressed: () => viewModel.setCallModeType(CallModeType.mesh),
                                ),
                              ),
                            ),
                          ),
