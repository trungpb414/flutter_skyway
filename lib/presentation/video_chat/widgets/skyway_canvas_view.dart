...
class SkywayCanvasView extends StatefulWidget {
  ...
  SkywayCanvasView({Key? key, required this.onViewCreated}) : super(key: key);
...
class _SkywayCanvasViewState extends State<SkywayCanvasView> {
  late _SkywayCanvasViewController _controller;
  ...
  Widget build(BuildContext context) {
    if (Platform.isAndroid) {
      ...
      return Text('$defaultTargetPlatform. is not yet supported by this project');
    }
  }
}
